...
def analyze_suspicious_bot_attacks(data, outputfilebotnet, private_ips_file, found_ips, private_bells_correlation_file):
    try:
        ...
        with open(outputfilebotnet, '+a') as f:
            ...
            priv_ips_in = suspicious_ips_data_reset['sourceIP'].unique()
...
def data_process(file_path, filename, output_file, output_file_block, private_info, outputfilebotnet, 
    ...
    try:
        ...
        if suspicious_ips.empty:
            ...
            with open(output_file_block, '+a') as f:
                ...
                print(f"\nSearching the {len(sus_ips_in)} most suspicious IPs in blocklists...")
                print("")
            ...
            with open(outputfilebotnet, 'w') as f:
                sys.stdout = f
                analyze_suspicious_bot_attacks(df, outputfilebotnet, private_info, found_ips,
